...
const Inicio = () => {
  return (
    ...
    >
      <div
        class="bg-blue-pucp absolute top-0 left-0 bg-gradient-to-b from-blue-pucp via-blue-pucp to-white bottom-0 leading-5 h-full w-full overflow-hidden">  
      </div>
      ...
      <div class="relative   min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
        <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
          <div class="self-start hidden lg:flex flex-col  text-gray-300">
            ...
            <h1 class="my-3 font-semibold text-4xl">Bienvenido al Sistema de Gestión de Tesis PUCP</h1>
            <p class="pr-3 text-sm opacity-75">Inicie sesión para poder utilizar todas las funcionalidades disponibles</p>
          </div>
        </div>
        <div class="flex justify-center self-center  z-10">
          <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
            <div class="mb-7">
              ...
              <p class="text-gray-400">No tienes una cuenta? <a href="#"
                  class="text-sm text-purple-700 hover:text-purple-700">Registrate</a></p>
            </div>
            <div class="space-y-6">
              <div class="">

                <input class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="" placeholder="Correo Electrónico"/>

                <input class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="" placeholder="Contraseña"/>
        ...
        <div class="container p-5 mx-auto  flex items-center justify-between ">
          <div class="flex mr-auto">
            <a href="https://codepen.io/uidesignhub" target="_blank" title="codepen aji" class="text-center text-gray-700 focus:outline-none"> 
            <img src="/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class="object-cover mx-auto w-8 h-8 rounded-full w-10 h-10"/><p class="text-xl">aji<strong>mon</strong></p> </a>
          </div>
